...
const initialMenus = [
  ...
  { id: "menu-notices", name: "공지사항", path: "/notices", parentId: null, order: 2, enabled: true },
  { id: "menu-system-management", name: "시스템 관리", path: "/system-management", parentId: null, order: 3, enabled: true },
